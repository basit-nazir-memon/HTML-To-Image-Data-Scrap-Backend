    ...
    const cardHtml = `
        ...
        <body>
            <div class="card">
                ...
                <p style="margin-top: 10px; margin-bottom: 25px; white-space: nowrap; overflow: hidden;text-overflow: ellipsis;display: inline-block; max-width: 100%; font-size: 23px;">${data.street ? data.street + ', ' : ''} ${data.city ? data.city + ', ' : ''} ${data.postcode ? data.postcode.slice(0, 3) : ''}</p>
